...
var proudctModel = new products_model_1.default();
var getAllProducts = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, proudctModel.getAllProducts()];
            case 1:
                allProducts = _a.sent();
...
var getProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, proudctModel.getProduct(parseInt(req.params.id))];
            case 1:
                product = _a.sent();
...
var createProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, proudctModel.createProduct(req.body)];
            case 1:
                product = _a.sent();
...
var updateProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, proudctModel.updateProduct(req.body)];
            case 1:
                product = _a.sent();
                res.status(201).json({ message: 'user updated successfully', product: product });
                return [3 /*break*/, 3];
            case 2:
                error_4 = _a.sent();
                next(error_4);
...
var deleteProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, proudctModel.deleteProduct(parseInt(req.params.id))];
            case 1:
                _a.sent();
