...
exports.authenticateUser = exports.deleteUser = exports.updateUser = exports.createUser = exports.getUser = exports.getAllUsers = void 0;
...
var getUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userModel.getUser(parseInt(req.params.id))];
            case 1:
                user = _a.sent();
...
var deleteUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userModel.deleteUser(parseInt(req.params.id))];
            case 1:
                _a.sent();
...
var authenticateUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var user, token, error_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userModel.authenticateUser(req.body.email, req.body.password)];
            case 1:
                user = _a.sent();
                if (!user)
                    return [2 /*return*/];
                token = jsonwebtoken_1.default.sign({ user: user }, envConfig.TOKEN_SERCRET);
