...
exports.removeProductFromOrder = exports.addProductToOrder = exports.deleteOrder = exports.updateOrder = exports.createOrder = exports.getOrder = exports.getAllOrders = void 0;
...
var getAllOrders = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ordersModel.getAllOrders()];
            case 1:
                allOrders = _a.sent();
...
var getOrder = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ordersModel.getOrder(parseInt(req.params.id))];
            case 1:
                order = _a.sent();
...
var createOrder = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ordersModel.createOrder(req.body)];
            case 1:
                order = _a.sent();
...
var updateOrder = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ordersModel.updateOrder(req.body)];
            case 1:
                order = _a.sent();
...
var deleteOrder = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ordersModel.deleteOrder(parseInt(req.params.id))];
            case 1:
                _a.sent();
...
var addProductToOrder = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ordersModel.addProductToOrder(req.body.product_id, parseInt(req.params.id), req.body.quantity)];
            case 1:
                _a.sent();
                res
                    .status(200)
...
var removeProductFromOrder = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var error_7;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ordersModel.removeProductFromOrder(Number(req.body.product_id), Number(req.params.id))];
            case 1:
                _a.sent();
                res
                    .status(200)
