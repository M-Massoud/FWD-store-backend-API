...
describe('all orders model methods should be defined', function () {
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, productModel.createProduct({ name: 'product 1', price: 99 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ordersModel.deleteOrder(1)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, userModel.deleteUser(1)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, productModel.deleteProduct(1)];
                case 3:
                    _a.sent();
    ...
    it('test create new order', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ordersModel.createOrder({
                        user_id: 1,
                        total_price: 190,
                    })];
                case 1:
    ...
    it('testing orders model get all orders method', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ordersModel.getAllOrders()];
                case 1:
                    response = _a.sent();
    ...
    it('testing orders model get one order method', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ordersModel.getOrder(1)];
                case 1:
                    response = _a.sent();
    ...
    it('test orders model update order method', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ordersModel.updateOrder({
                        id: 1,
                        user_id: 1,
                        total_price: 200,
                    })];
    ...
    it('testing orders model delete order method', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
